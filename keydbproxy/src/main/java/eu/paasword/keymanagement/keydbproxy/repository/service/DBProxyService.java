...
public class DBProxyService {
    ...
    public String queryHandler(QueryContext query) {
        ...
        try {
            ...
            PaaSwordSecurityKey paeskey = SecurityUtil.deSerializeObject(new String(base64decodedBytes1, "utf-8"), PaaSwordSecurityKey.class);
            String testmsg = "test input";
            String symencrypted = SecurityUtil.encryptSymmetrically(paeskey, testmsg);
            String symdecrypted = SecurityUtil.decryptSymmetrically(paeskey, symencrypted);
            if (symdecrypted.equalsIgnoreCase(testmsg)) {
            ...
            PaaSwordSecurityKey AppAESkey = SecurityUtil.deSerializeObject(new String(base64decodedBytes2, "utf-8"), PaaSwordSecurityKey.class);
            String testmsg2 = "test input2";
            String symencrypted2 = SecurityUtil.encryptSymmetrically(AppAESkey, testmsg2);
            ...
            PaaSwordSecurityKey ProxyAESkey = SecurityUtil.deSerializeObject(new String(base64decodedBytes3, "utf-8"), PaaSwordSecurityKey.class);

            String testmsg3 = "test input3";
            String symencrypted3 = SecurityUtil.encryptSymmetrically(AppAESkey, testmsg3);
            ...
            PaaSwordSecurityKey mergedkey = SecurityUtil.mergeKeysInParts(paeskey, AppAESkey, ProxyAESkey);

            //check that key is correct
            String unencrypted4 = "test";
            String symencrypted4 = SecurityUtil.encryptSymmetrically(mergedkey, unencrypted4);
            ...
            ret = SecurityUtil.decryptSymmetrically(mergedkey, base64encrypted);
